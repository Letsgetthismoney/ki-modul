...
def augment_data(df):
    ...
    # Berechnung die Gesamtzahl der Zimmer
    df_aug['rooms'] = df_aug["bathrooms"] + df_aug['bedrooms'] + df_aug['guestroom']

    # Berechnung der Fläche pro Raum
    df_aug['area_per_room'] = df_aug['area'] / df_aug['rooms']
